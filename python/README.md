...
```text
dist/mlrecorder-0.1.2-py3-none-win_amd64.whl
```
...
```bat
pip install dist\mlrecorder-0.1.2-py3-none-win_amd64.whl
```

Para reinstalar en desarrollo:

```bat
pip install --force-reinstall dist\mlrecorder-0.1.2-py3-none-win_amd64.whl
```
